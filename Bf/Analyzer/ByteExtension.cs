...
namespace Bf.Analyzer
{
   ...
   {
      static ReadOnlySpan<byte> ReciprocalTable => new byte[]
      {
      ...
      static ReadOnlySpan<byte> TrailingZeroCountTable => new byte[]
      {
      ...
      public static byte Reciprocal(this byte value, out byte shiftRight)
      {
         // (byte)((value >> shiftRight) * result) == 1
         shiftRight = TrailingZeroCountTable[value];
         return ReciprocalTable[value >> (shiftRight + 1)];
      }
   }
}
